...
describe("Fluxo completo de compra na SauceDemo", () => {
  ...
  it("não deve realizar login com usuário inválido", () => {
    LoginPage.visit();
  ...
  it("não deve permitir avançar no checkout sem preencher informações obrigatórias", () => {
    // Login válido
    LoginPage.visit();
    LoginPage.login("standard_user", "secret_sauce");
  ...
  it("não deve finalizar pedido sem preencher o formulário de checkout completamente (capturando erro)", () => {
    // Login válido
    LoginPage.visit();
    LoginPage.login("standard_user", "secret_sauce");
